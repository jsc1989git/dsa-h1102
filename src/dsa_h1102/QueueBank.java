...
public class QueueBank {
    public static void main(String[] args) {
        ...
        //Initialize boolean flag to control the loop
        boolean done = false;
        ...
        while (!done) {
            ...
            //Use a switch statement to handle the commands
            switch (command) {
                case "join":
                    ...
                    //Print a message indicating that the user has joined the line
                ...
                case "serve":
                    ...
                    if (line.isEmpty()) {
                        ...
                        //Print a message indicating that the next customer has been served
